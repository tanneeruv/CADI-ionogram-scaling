...
#f = open("5D140500.md4", "rb")
#f = open("5D240100.md4", "rb")
#f = open("5H140000.md4", "rb")
#f = open("5H151000.md4", "rb")
f = open("4A141400.md4", "rb")
#f = open("5E111500.md4", "rb")
#f = open("5D151100.md4", "rb")
#f = open("5D300200.md4", "rb")
#f = open ("5G100000.md4", "rb")
...
try:
   ...
   # --- noise reduction - remove lowest and highest frequency for each height
      ...
      for i in range(len(frequency)):      
            if (height[i] > 90 and height[i] <= 150):
                EL.append((time,height[i],frequency[i]))
            elif (height[i] > 160 and height[i] <= 290):
                F1L.append((time,height[i],frequency[i]))
            elif (height[i] > 300 and height[i] <= 600):
                F2L.append((time,height[i],frequency[i]))
      
      #print(EL)
      fl=open("SegEL.txt","a+")
      fl.write(str(EL)+'\n\n\n')
      fl=open("SegF1L.txt","a+")
      fl.write(str(F1L)+'\n\n\n')
      fl=open("SegF2L.txt","a+")
      fl.write(str(F2L)+'\n\n\n')
